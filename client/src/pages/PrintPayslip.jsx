                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-3">
                                ...
                                {lateCount > 0 && (
                                    <AttBox
                                        ...
                                        value={lateCount}
                                        sub={lateDeductionDays > 0
                                            ? `${lateDeductionDays} day deducted (every 3 lates)`
                                            : `${3 - (lateCount % 3)} more = 1 day deduct`
                                        }
                                        color={lateDeductionDays > 0 ? "rose" : "amber"}
                                    />
                                )}
                            </div>
                        </div>
    ...
    />
                        ...
                        {lateDeductionDays > 0 && (
                            <div className="rounded-xl bg-amber-50 border border-amber-200 px-5 py-3 text-xs text-amber-700">
                                <span className="font-semibold">Late Attendance Policy:</span>{" "}
