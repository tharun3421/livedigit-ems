...
import EditPayslipModal from "./EditPayslipModal"          // add
import { format } from "date-fns"
import { Download, Pencil } from "lucide-react"           // add Pencil

const PayslipList = ({ payslips, isAdmin, onRefresh }) => {  // add onRefresh prop
    ...
    return (
        ...
        {editing && (
            <EditPayslipModal
                ...
                onSuccess={onRefresh}     // refreshes the list after save
            />
        )}
        </>
    )
