...
//             <input type="email" value={email} onChange={(e)=> setEmail(e.target.value)} required placeholder='tharun@example.com' />
//           </div>
//           <div>
//             <label className='block text-sm font-medium text-slate-700 mb-2'> Password</label>
//             <div className='relative'>
//               <input className='pr-11' type={showPassword? 'text':'password'} value={password} onChange={(e)=> setPassword(e.target.value)} required placeholder='........' />
//             <button onClick={()=> setShowPassword(!showPassword)} className='absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors' type='button'>{showPassword? <EyeOffIcon size={18}/>: <EyeIcon size={18}/>}</button>
//             </div>
