...
export const getMonthAttendanceMap = async (req, res) => {
    try {
        ...
        const [attendanceRecords, regularizations, lateRegs] = await Promise.all([
        ...
        for (const r of attendanceRecords) {
            ...
            attMap[key]   = {
                ...
                workingHours: r.workingHours, dayType: r.dayType,
            }
        }
        ...
        return res.json({ data: { attendance: attMap, regularizations: regMap, lateRegularizations: lateRegMap, year, month } })
    } catch (err) {
    ...
    try {
        ...
        await Promise.all(adminIds.map(adminId =>
            createNotification({
                ...
                refId:         reg._id,
                refType:       "AttendanceRegularization",
            })
        ))
