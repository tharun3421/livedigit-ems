...
const EmployeeForm = ({ initialData, onSuccess, onCancel, isAdmin = false }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
      ...
      <div className="card p-5 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-900">
          ...
          <div>
            ...
            <input
              type="number" name="basicSalary" required min="0" step="0.01"
          ...
          {/* <div>
            <label className="block mb-2">Allowances</label>
            <input
              type="number" name="allowances" required min="0" step="0.01"
          ...
          {/* <div>
            <label className="block mb-2">Deductions</label>
            <input
              type="number" name="deductions" required min="0" step="0.01"
      ...
      {/* ── Account Setup ── */}
      <div className="card p-5 sm:p-6">
        <h3 className="text-base font-medium mb-6 pb-4 border-b border-slate-100 text-slate-900">
          Account Setup
        </h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm">
          ...
          {!isEditMode && (
            <div>
              <label className="block mb-2 text-slate-900">Temporary Password</label>
              <input type="password" name="password" required className="text-slate-900" />
            </div>
          )}
          {isEditMode && (
            <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-900">
            <div className="sm:col-span-2">
              ...
              <input
                ...
                defaultValue={initialData?.bankDetails?.accountHolderName}
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                defaultValue={initialData?.bankDetails?.ifscCode}
              />
            </div>
          </div>
        </div>
